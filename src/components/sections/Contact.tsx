            ...
            <div className="md:w-2/5 bg-primary-700 text-white p-8 md:p-12">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/in/%E6%96%87%E6%93%8E-%E6%99%BA%E5%88%9B-8477a536a/" className="w-10 h-10 rounded-full bg-primary-600 flex items-center justify-center hover:bg-primary-500 transition-colors" target="_blank" rel="noopener noreferrer">
